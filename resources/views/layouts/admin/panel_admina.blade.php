    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush">
                <a href="#" class="list-group-item list-group-item-action">Potwierdź wizyty</a>
                <a href="#" class="list-group-item list-group-item-action">Mój profil</a>
                <a href="#" class="list-group-item list-group-item-action">Lista moich klientów</a>
